...
category = [
    {"title": 'Главная', "func_name": 'index'},
    {"title": 'Задание с кнопкой', "func_name": 'button'},
    {"title": 'Задание с картинкой', "func_name": 'image'},
    {"title": 'Загрузка изображения', "func_name": 'image_get'},
    {"title": 'Страница авторизации', "func_name": 'login'},
    {"title": 'Отправка текста', "func_name": 'send'},
    {"title": 'Калькулятор', "func_name": 'calc'},
    {"title": 'Проверка возраста', "func_name": 'check_age'},
    {"title": 'Возведение в квадрат', "func_name": 'square'},
    {"title": 'flash сообщение', "func_name": 'flas'},
    {"title": 'Log страница', "func_name": 'log'}
]
